...
int main(int argc, char* argv[])
{
  ...
  vtkNew<vtkCameraRotateAxisSource> src;
  ...
  std::cout << "vtkCameraRotateAxisSource output:\n";
  ...
  renderWindow->SetWindowName("vtkCameraRotateAxisSource");
